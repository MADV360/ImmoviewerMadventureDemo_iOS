...
GLPlainFilter::GLPlainFilter()
        : GLFilter(&VertexShaderSource, 1, &FragmentShaderSource, 1)
{

}

void GLPlainFilter::render(GLVAO* ptrVAO, GLint sourceTexture, GLenum sourceTextureTarget) {
...
void GLPlainFilter::prepareGLProgramSlots(GLint program) {
