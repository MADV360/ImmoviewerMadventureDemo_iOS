...
GLInverseColorFilter::GLInverseColorFilter()
        : GLFilter(&VertexShaderSource, 1, &FragmentShaderSource, 1)
{

}

void GLInverseColorFilter::render(GLVAO* ptrVAO, GLint sourceTexture, GLenum sourceTextureTarget) {
...
void GLInverseColorFilter::prepareGLProgramSlots(GLint program) {
